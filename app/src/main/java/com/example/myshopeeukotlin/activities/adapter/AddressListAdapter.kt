...
import com.example.myshopeeukotlin.activities.AddEditAddressActivity
import com.example.myshopeeukotlin.activities.CheckoutActivity
...
open class AddressListAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.findViewById<TextView>(R.id.address_mobile_number).text =
                "${model.mobileNumber}"
            ...
            if (selectAddress) {
                holder.itemView.setOnClickListener {
                    ...
                    Toast.makeText(context, "${model.address}${model.zipCode}", Toast.LENGTH_LONG)
                        .show()
                }
            }
